...
bestehende Komponenten implementiert werden. Die Unity3D-spezifischen Aspekte
sind in der obersten Schicht gekapselt, wodurch perspektivisch auch andere
Simulationsumgebungen integriert werden könnten, solange die definierten
Interfaces beibehalten werden.
