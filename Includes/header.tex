...
\rohead[\pagemark]{\small{\textnormal{\headmark}} \hfill \pagemark}% Headmark left, page number right
...
% Customize chapter markings - remove "Kapitel" prefix and use number + name format
