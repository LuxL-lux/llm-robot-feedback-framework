...
% Figures: continuous numbering 1,2,3… (not per chapter) and no trailing dot
\usepackage{chngcntr}
\counterwithout{figure}{chapter}
\renewcommand{\thefigure}{\arabic{figure}}
\KOMAoptions{numbers=noenddot}

% Tables: continuous numbering 1,2,3… (not per chapter)
\counterwithout{table}{chapter}
\renewcommand{\thetable}{\arabic{table}}

% Footnotes: continuous numbering across chapters
...
\addbibresource{Abschlussarbeit_biber.bib}
